...
if ( ! function_exists('get_filenames'))
{
	 ...
	 * @param	bool	whether to recurse folders
	 * @param	bool	internal variable to determine recursion status - do not use in calls
	 * @return	array
	 */
	function get_filenames($source_dir, $include_path = FALSE, $recursive = FALSE, $_recursion = FALSE)
	{
		...
		if ($fp = @opendir($source_dir))
		{
			...
			while (FALSE !== ($file = readdir($fp)))
			{
				...
				{
          if ($recursive)
  					get_filenames($source_dir.$file.DIRECTORY_SEPARATOR, $include_path, $recursive, TRUE);
				}
				elseif ($file[0] !== '.')
				{
