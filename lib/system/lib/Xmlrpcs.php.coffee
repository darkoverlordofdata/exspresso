...
if not class_exists('ExspressoXmlrpc')
    ...
    if $objectCall is true
      if $method_parts[0] is "this" and $system_call is true
        ...
        if @object is false
          ...
          return $controller[$method_parts]['1']($m)
...
register_class 'ExspressoXmlrpcs', ExspressoXmlrpcs
module.exports = ExspressoXmlrpcs
#  END XML_RPC_Server class


#  End of file Xmlrpcs.php 
#  Location: ./system/lib/Xmlrpcs.php