...
#|--------------------------------------------------------------------------
#|
#| The connect.js logging style. Uses Connect.js values:
#|
...
#|
#
exports['logger'] = 'tiny' # default|short|tiny|dev
...
#|--------------------------------------------------------------------------
#|
#| The view folder name. View folders in application/
#| or in modules/<name>/ will be searched for view templates
#|
#
exports['views'] = 'views'
...
#|--------------------------------------------------------------------------
#|
#| How to cache pages. Rules are stored in a hash, the key being the
#| url to match, and the value is the cache expiration time for matching
#| pages.
#|
#
exports['cache_rules'] =
...
#|--------------------------------------------------------------------------
#|
#| By default Exspresso uses search-engine friendly segment based URLs:
#| example.com/who/what/where/
#|
#| By default Exspresso enables access to the $_GET array.  If for some
...
#| this feature is enabled, since Exspresso is designed primarily to
...
exports['sess_table_name']		= 'sessions'
