...
{config, date, defined, explode, floor, function_exists, get_instance, gmdate, is_numeric, item, lang, line, load, mktime, preg_match, preg_replace, str_replace, strlen, strtolower, substr, time, trim}  = require(FCPATH + 'pal')
