...
{_escape_identifiers, count, database, db, defined, escape, extract, in_array, mysql_fetch_field, mysql_field_type, name, num_rows, preg_replace, query, result_array, result_id, strtolower}  = require(FCPATH + 'pal')
