...
{_escape_identifiers, _protect_identifiers, array_change_key_case, array_key_exists, count, db, db_debug, defined, display_error, implode, is_array, is_numeric}	= require(FCPATH + 'helper')
...
register_class 'CI_DB_odbc_forge', CI_DB_odbc_forge
module.exports = CI_DB_odbc_forge
