...
{_escape_identifiers, _protect_identifiers, array_change_key_case, array_key_exists, count, db, db_debug, defined, display_error, implode, is_array, is_numeric}  = require(FCPATH + 'pal')
