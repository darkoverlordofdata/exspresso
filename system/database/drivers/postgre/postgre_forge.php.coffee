...
{_escape_identifiers, _protect_identifiers, array_change_key_case, array_key_exists, count, db, defined, false, implode, in_array, is_array, is_numeric, str_replace, strpos, strtoupper, table_exists}  = require(FCPATH + 'helper')
