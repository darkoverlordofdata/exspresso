...
{_escape_identifiers, _protect_identifiers, array_change_key_case, array_key_exists, count, db, defined, implode, is_array, is_numeric}  = require(FCPATH + 'pal')
...
register_class 'CI_DB_oci8_forge', CI_DB_oci8_forge
module.exports = CI_DB_oci8_forge
