...
{cache_off, cachedir, chmod, defined, delete_files, get_instance, helper, is_dir, load, md5, mkdir, preg_replace, read_file, segment, serialize, unserialize, uri, write_file}  = require(FCPATH + 'pal')
