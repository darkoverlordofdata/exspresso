...
{array_keys, count, defined, explode, in_array, nl2br, preg_match, preg_match_all, preg_replace, preg_replace_callback, preg_split, rtrim, str_replace, strpos}  = require(FCPATH + 'lib')
