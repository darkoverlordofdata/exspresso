...
{__construct, ceil, config, count, defined, floor, get, get_instance, input, is_numeric, item, preg_replace, rtrim, segment, uri}	= require(FCPATH + 'helper')
