...
{__construct, count, debug_backtrace, defined, function_exists, get_instance, gettype, in_array, is_array, is_bool, is_null, lang, language, line, load, preg_match, str_replace, strtolower}  = require(FCPATH + 'pal')
