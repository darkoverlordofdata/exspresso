...
{__construct, count, date, defined, get_instance, getdate, in_array, line, load, mktime, preg_match, preg_replace, str_replace, strlen, temp, time, ucfirst}  = require(FCPATH + 'pal')
