...
{__construct, array_splice, call_user_func, count, defined, fmod, func_get_args, is_array, is_callable, is_null, is_object, list_fields, method_exists, num_rows, result_array, str_replace, temp}	= require(FCPATH + 'helper')
